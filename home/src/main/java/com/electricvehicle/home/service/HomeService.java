package com.electricvehicle.home.service;
...
import com.electricvehicle.home.exception.FileStorageException;
...
public class HomeService {
    ...
    @Autowired
    public HomeService(FileStorageProperties fileStorageProperties){
    ...
    public String storeFile(MultipartFile file) {
        ...
        try {
            ...
            long tick = System.currentTimeMillis()*1000 + TICKS_AT_EPOCH;
    ...
    public Resource localFileAsResource(String fileName) {
        try {
